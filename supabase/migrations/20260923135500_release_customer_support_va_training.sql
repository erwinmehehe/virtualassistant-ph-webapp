-- Release the reviewed Customer Support Virtual Assistant course.
-- Editorial review complete. The course preserves policy, refund, payment, account-security, and escalation boundaries.
...
set
  ...
  content_version = greatest(content_version, 2),
  updated_at = now()
where slug = 'customer-support-virtual-assistant';
