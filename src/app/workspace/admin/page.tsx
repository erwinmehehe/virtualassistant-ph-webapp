...
export default async function AdminPage() {
  ...
  return <>
    ...
    <div className="page-head agency-page-head"><div><div className="kicker">Agency overview</div><h1>Build your next great placement.</h1><p>Follow up with employers, move hiring forward, and keep every commitment visible.</p></div><Link className="btn btn-primary" href="/workspace/admin/leads">Open lead pipeline <ArrowRight size={16}/></Link></div>
