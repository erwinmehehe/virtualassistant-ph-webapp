  ...
  return (
    <div className="app-shell">
      ...
      <main className="app-main" id="main-content">
        <div className="app-topbar"><div className="app-topbar-inner"><div className="app-topbar-title"><h1>{title}</h1><span className="db-pill indigo">{role}</span></div><Link className="btn btn-sm app-topbar-public" href="/" target="_blank"><ExternalLink size={15}/><span>Public site</span></Link></div></div>
