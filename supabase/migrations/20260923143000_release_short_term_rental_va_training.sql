-- Release the reviewed Airbnb / Short-Term Rental Virtual Assistant course.
...
where module_id in (
  ...
  where course_id = (select id from public.training_courses where slug = 'airbnb-short-term-rental-virtual-assistant')
);
