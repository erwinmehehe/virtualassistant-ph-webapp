...
export const BLOG_KEYWORD_SUPPORT_GUIDES: BlogPost[] = [
  ...
  },
  {
    ...
    "description": "Learn which Xero Virtual Assistant tasks to delegate across document collection, coding prep, bank matching, reconciliation support, receivables, and month-end prep.",
  ...
  },
  {
    ...
    "description": "Learn which QuickBooks Virtual Assistant tasks to delegate across bookkeeping admin, invoices, document collection, matching, receivables, exceptions, and month-end prep.",
  ...
  },
  {
    ...
    "description": "Learn which Canva Virtual Assistant tasks to delegate across social graphics, presentations, templates, resizing, lead magnets, thumbnails, asset QA, and file organization.",
