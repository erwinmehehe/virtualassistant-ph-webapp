...
export default async function PricingPage(){
  ...
  const managedMarkup=settings.managedMarkupPercent; // Internal only. Never expose this percentage on public pricing.
  ...
  return <><SiteHeader/><main id="main-content" className="pricing-page">
    ...
    <section className="section section-white"><div className="container"><div className="section-head"><h2>Current pricing structure</h2><p>Virtual Assistant compensation and our service fee are separate. You see both before you commit.</p></div><div className="grid-2">
      <article className="card pricing-card"><span className="pricing-label">Managed Virtual Assistant service <span className="badge badge-success">Recommended</span></span><h3>Ongoing managed support</h3><div className="pricing-value">Role-based quote</div><p className="muted">Your quote covers the managed service around the placement, including recruiting, vetting, matching, onboarding, Client Success, placement monitoring, recovery, replacement support, and billing administration. Your exact client price and terms are confirmed before you make a hiring commitment.</p><ul className="check-list"><li>Recruiting, screening, and matching</li><li>Structured placement launch</li><li>Ongoing Client Success and placement monitoring</li><li>Recovery and replacement support under your agreed terms</li></ul><Link className="btn btn-primary" href="/hire">Get Your Shortlist <ArrowRight size={16}/></Link></article>
      <article className="card pricing-card"><span className="pricing-label">Direct hire</span><h3>One-time placement fee</h3><div className="pricing-value">$350</div><p className="muted">Prefer to manage the Virtual Assistant yourself after the hire? Pay a one-time $350 placement fee for role review, candidate sourcing, screening, vetting, shortlist preparation, interview coordination, and placement support. You manage the Virtual Assistant directly after placement.</p></article>
    </div>
    ...
    <section className="section"><div className="container"><div className="section-head"><h2>See what a virtual assistant could save you.</h2><p>Compare the estimated base labour cost of a Filipino virtual assistant with a local hire using your own hours and hourly rates. The calculator keeps agency fees and other overhead separate so the comparison stays transparent.</p></div><VaCostCalculator/></div></section>
