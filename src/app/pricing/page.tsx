...
export default async function PricingPage(){
  ...
  return <><SiteHeader/><main id="main-content" className="pricing-page">
      ...
      <div className="container pricing-hero-grid">
        <div className="pricing-hero-copy">
          ...
          <div className="pricing-hero-actions">
            <Link className="btn btn-primary" href="/hire">Get your free VA match <ArrowRight size={16}/></Link>
            <Link className="btn" href="/book-client-call">Discuss your VA needs</Link>
          </div>
    ...
    <section className="section section-white"><div className="container"><div className="section-head"><h2>Current pricing structure</h2><p>Virtual Assistant compensation and our service fee are separate. You see both before you commit.</p></div><div className="grid-2">
      <article className="card pricing-card"><span className="pricing-label">Managed Virtual Assistant service <span className="badge badge-success">Recommended</span></span><h3>Ongoing managed support</h3><div className="pricing-value">Role-based quote</div><p className="muted">Your quote covers recruiting, vetting, matching, onboarding, Client Success, placement monitoring, recovery, replacement support, and billing administration. Your exact client price and terms are confirmed before you make a hiring commitment.</p><ul className="check-list"><li>Recruiting, screening, and matching</li><li>Structured placement launch</li><li>Ongoing Client Success and placement monitoring</li><li>Recovery and replacement support under your agreed terms</li></ul><Link className="btn btn-primary" href="/hire">Get your free VA match <ArrowRight size={16}/></Link></article>
