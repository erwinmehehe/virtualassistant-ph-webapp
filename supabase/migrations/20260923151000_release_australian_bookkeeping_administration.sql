-- Release the reviewed Australian Bookkeeping Administration course.
...
where module_id in (
  ...
  where course_id = (
    select id from public.training_courses where slug = 'australian-bookkeeping-administration'
  )
);
