...
export default async function HomePage({ searchParams }: { searchParams: Promise<Record<string, string | undefined>> }) {
  ...
  return <><SiteHeader/><main id="main-content">
    ...
    <section className="section product-paths-section"><div className="container"><div className="section-head"><h2>A guided hiring workflow.</h2><p>Create a clear hiring brief and follow your next steps in the workspace.</p></div><div className="product-path-grid"><div className="card product-path-card"><div className="product-path-icon"><WandSparkles size={20}/></div><h3>For clients: create a role in 4 steps</h3><p>Role & skills → scope & schedule → budget & support → review. Skill chips, budget guidance, local autosave, and a final review screen keep job posts clear without turning the form into a wall of fields.</p><div className="mini-step-row"><span>1 Role</span><span>2 Scope</span><span>3 Budget</span><span>4 Review</span></div><Link className="btn btn-primary" href="/auth/join/client?next=%2Fworkspace%2Fclient%2Fjobs%2Fnew">Post your first job</Link></div></div></div></section>
