-- Release the reviewed Sales & Lead Generation Virtual Assistant course.
...
where module_id in (
  ...
  where course_id = (select id from public.training_courses where slug = 'sales-lead-generation-virtual-assistant')
);
