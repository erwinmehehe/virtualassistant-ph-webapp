...
export default async function RecruiterDashboard(){
  ...
  const openLeads=(recentLeadsRes.data||[]).filter((lead:any)=>isOpenLeadStage(lead.crm_stage));
  ...
  const cards=[
    ...
    ["Open client pipeline",openLeads.length,"/workspace/recruiter/leads?view=open",Mail,`Tracked opportunities · ${openPipelineValue.toLocaleString()} estimated value`]
  ] as const;
  const today=[
