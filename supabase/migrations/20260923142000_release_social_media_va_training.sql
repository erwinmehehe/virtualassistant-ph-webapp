-- Release the reviewed Social Media Virtual Assistant course.
...
where module_id in (
  ...
  where course_id = (select id from public.training_courses where slug = 'social-media-virtual-assistant')
);
