...
export default async function PricingPage(){
  ...
  return <><SiteHeader/><main id="main-content" className="pricing-page">
    ...
    <section className="section"><div className="container"><div className="section-head"><h2>Estimate the monthly Virtual Assistant cost.</h2><p>Use your intended hours and hourly rate. The calculator shows the managed service margin and the $350 one-time direct-hire placement fee separately when they apply.</p></div><VaCostCalculator placementFee={350} managedMarkup={managedMarkup}/></div></section>
