...
export default async function HomePage() {
  ...
  return <><SiteHeader/><main id="main-content">
    ...
    <section className="hero"><div className="container hero-grid"><div><h1>Virtual Assistant Philippines</h1><p>We recruit, screen, and match experienced Filipino remote professionals to your business — with ongoing placement support after they start, not just an introduction.</p><div className="row wrap hero-actions"><Link className="btn btn-primary btn-lg" href="/hire">Get a managed VA <ArrowRight size={17}/></Link><Link className="btn btn-lg" href="/find-talent">Browse VAs</Link></div><p className="small muted hero-trust-row">Skills tested &middot; Human vetted &middot; 2+ years experience &middot; 30-day replacement support</p><p className="supply-link">Looking for VA work? <Link href="/jobs">Browse VA jobs.</Link></p></div>
