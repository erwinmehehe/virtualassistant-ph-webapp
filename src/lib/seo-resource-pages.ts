...
const CANDIDATE_RESOURCE_PAGES: SeoResourcePage[] = [
  {
    ...
    metaDescription: "Learn how to apply as a Virtual Assistant in the Philippines, prepare your profile, choose suitable jobs, complete screening, and avoid common application mistakes.",
  ...
  },
  {
    ...
    metaDescription: "Build a Virtual Assistant resume that shows relevant tasks, tools, results, remote-work evidence, and role fit. Includes a practical resume structure and examples.",
  ...
  },
  {
    ...
    metaDescription: "Review practical Virtual Assistant requirements in the Philippines, including equipment, internet, workspace, communication, skills, profile evidence, and availability.",
  ...
  },
  {
    ...
    metaDescription: "Start Virtual Assistant work with no direct VA experience by using transferable skills, practice projects, a focused niche, honest work samples, and entry-level roles.",
  ...
  },
  {
    ...
    metaDescription: "Understand part-time Virtual Assistant work in the Philippines, including schedules, workload fit, availability, compensation, application tips, and common role types.",
