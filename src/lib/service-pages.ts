...
export const SERVICE_PAGES: ServiceSeoPage[] = [
  ...
  },
  {
    ...
    "metaDescription": "Hire an Administrative Virtual Assistant in the Philippines for inbox, calendar, data entry, research, CRM updates, documents and recurring admin support.",
