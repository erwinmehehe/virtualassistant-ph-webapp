...
export default async function AdminFinancePage(){
  ...
  return <>
    <div className="page-head"><div><h1>Agency Finance OS</h1><p>Know what every managed placement is expected to earn, protect the margin floor, and reconcile VA compensation collections without mixing private agency economics into client or VA views.</p></div><Link className="btn" href="/workspace/admin/settings">Finance settings</Link></div>
