...
const rows: [string, string, string][] = [
  ...
  ["Onboarding", "Structured onboarding support", "Your team handles it"],
  ...
  ["Payment model", "Virtual Assistant compensation + ongoing service margin", "Virtual Assistant compensation + one-time placement fee"],
  ["Best for", "Teams that want backup and accountability built in", "Teams confident managing the Virtual Assistant relationship solo"]
];
...
export default function ManagedVsDirectHirePage() {
  return <><SiteHeader/><main id="main-content">
    <section className="section public-hero-small"><div className="container"><div className="public-page-head">
      <h1 className="public-page-title">Managed Virtual Assistant vs. Direct Hire</h1>
      <p className="public-lede">Both start the same way -- we recruit, screen, and match a vetted candidate to your role. The difference is what happens after your Virtual Assistant starts.</p>
      <div className="row wrap" style={{ marginTop: 20 }}><Link className="btn btn-primary btn-lg" href="/hire">Get a managed Virtual Assistant <ArrowRight size={16}/></Link><Link className="btn btn-lg" href="/pricing">See pricing</Link></div>
    </div></div></section>
    ...
    <section className="section section-white"><div className="container">
      <div className="table-wrap responsive-table" style={{ background: "#fff" }}><table>
        <thead><tr><th></th><th>Managed Virtual Assistant</th><th>Direct hire</th></tr></thead>
        <tbody>{rows.map(([label, managed, direct]) => <tr key={label}>
          <td data-label=""><strong>{label}</strong></td>
          <td data-label="Managed Virtual Assistant">{managed}</td>
    ...
    <section className="section"><div className="container">
      <div className="section-head"><h2>The first 30 days with a Managed Virtual Assistant.</h2><p>What a typical Managed Virtual Assistant onboarding looks like -- your 30-day replacement window runs alongside this.</p></div>
    ...
    <section className="section"><div className="container public-content-grid">
      <div className="card stack"><h3><CheckCircle2 size={18}/> Choose Managed Virtual Assistant if...</h3>
