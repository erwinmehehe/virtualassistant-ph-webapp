...
export default async function RecruiterDashboard(){
  ...
  const cards=[
    ["Virtual Assistants waiting for your review",unreviewedRes.count||0,"/workspace/recruiter/queue",ClipboardList,"Candidates waiting for screening"],
    ...
    ["Vetted but not listed",vettedHiddenRes.count||0,"/workspace/recruiter/talent?readiness=vetted_hidden",UserRoundCheck,"Screened Virtual Assistants still missing profile items"],
    ...
    ["New applications",newAppsRes.count||0,"/workspace/recruiter/matching?view=applications",CheckCircle2,"Fresh Virtual Assistant applications across roles"],
  ...
  const today=[
    ...
    {priority:"medium",title:"Vetted Virtual Assistants not yet listed",count:vettedHiddenRes.count||0,copy:"Screening is done but the profile is incomplete. Send a reminder naming what is missing.",href:"/workspace/recruiter/talent?readiness=vetted_hidden"},
    {priority:"medium",title:"Virtual Assistants waiting for review",count:unreviewedRes.count||0,copy:"Complete screening so strong talent can become matchable.",href:"/workspace/recruiter/queue"},
  ...
  return <>
    <div className="page-head"><div><div className="kicker">Recruiter control center</div><h1>Today’s work</h1><p>Start at the top of the action queue. Each item is blocking a client, a candidate, or an open role.</p></div><div className="row wrap"><Link className="btn" href="/workspace/recruiter/talent">Open Virtual Assistant directory</Link><Link className="btn btn-primary" href="/workspace/recruiter/matching">Match active roles</Link></div></div>
