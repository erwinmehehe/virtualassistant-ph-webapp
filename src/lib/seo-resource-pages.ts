...
const CANDIDATE_RESOURCE_PAGES: SeoResourcePage[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      ,{ heading: "Add success metrics and decision boundaries", paragraphs: ["State how the client will know the role is working after 30 days. Use measures tied to the workflow, such as backlog age, response time, record accuracy, completed follow-ups, publishing quality, or the number of normal cases completed without manager intervention.", "Define which decisions the Virtual Assistant may make, which require approval, and which must be escalated immediately. Clear decision boundaries are especially important when the role touches customers, money, confidential records, publishing, or account access."], bullets: ["Definition of done", "Quality standard", "Response or completion window", "Routine decisions", "Approval points", "Immediate escalation triggers"] }
      ,{ heading: "Copy-ready Virtual Assistant job description template", paragraphs: ["Copy and adapt this structure: We are hiring a [specific role title] to own [primary outcome]. The role will handle [three to six recurring responsibilities] using [systems]. The schedule is [weekly hours, timezone, and live overlap], with compensation of [range and currency]. Success in the first 30 days means [measurable outputs]. The role may decide [routine decisions] and must escalate [exceptions].", "Add the reporting line, required experience, equipment expectations, application evidence, interview process, start timing, and working arrangement. Remove any field that does not apply. A shorter specific description is more useful than a long list of unrelated tasks."], bullets: ["Specific title and outcome", "Recurring responsibilities", "Tools and source of truth", "Hours, timezone, and pay", "Success measures", "Decision and escalation rules"] }
    ],
    faqs: [
