...
export default async function HomePage({ searchParams }: { searchParams: Promise<Record<string, string | undefined>> }) {
  ...
  return <><SiteHeader/><main id="main-content">
    ...
    <section className="hero home-hero"><div className="container hero-grid hero-grid-form"><div className="home-hero-copy"><div className="home-hero-kicker">Virtual Assistant Philippines</div><h1>Hire a Vetted Virtual Assistant in the Philippines</h1><p className="home-hero-lede">We recruit, screen, and match experienced Filipino virtual assistants to your business — with ongoing placement support after they start, not just an introduction.</p><p className="hero-positioning">A clearer way for Australian, US, and UK businesses to build a reliable Filipino remote team.</p><div className="row wrap hero-actions"><Link className="btn btn-primary btn-lg" href="/hire">Get matched <ArrowRight size={17}/></Link><Link className="btn btn-lg" href="/find-talent">Browse approved VAs</Link></div><div className="home-hero-proof"><span><CheckCircle2 size={15}/> Skills tested</span><span><CheckCircle2 size={15}/> Video reviewed</span><span><CheckCircle2 size={15}/> Recruiter approved</span></div></div>
    ...
    <section className="home-trust-strip" aria-label="Hiring standards"><div className="container home-trust-grid"><div className="home-trust-item"><strong>2+ years experience</strong><span>Required for public VA profiles</span></div><div className="home-trust-item"><strong>Role-specific screening</strong><span>Skills test before approval</span></div><div className="home-trust-item"><strong>Human recruiter review</strong><span>Communication and client readiness checked</span></div><div className="home-trust-item"><strong>Transparent compensation</strong><span>VA pay and service fee shown separately</span></div></div></section>
    ...
    <section className="section product-paths-section"><div className="container"><div className="section-head"><h2>A clearer hiring workflow from role brief to shortlist.</h2><p>Clients get a structured path to define the work, compare approved candidates, and move the strongest fits forward without starting from a blank dashboard.</p></div><div className="grid-2 product-path-grid"><div className="card product-path-card product-path-card-primary"><div className="product-path-icon"><WandSparkles size={20}/></div><h3>Create a clear role in 4 steps</h3><p>Role & skills → scope & schedule → budget & support → review. Skill chips, budget guidance, local autosave, and a final review screen keep job posts clear without turning the form into a wall of fields.</p><div className="mini-step-row"><span>1 Role</span><span>2 Scope</span><span>3 Budget</span><span>4 Review</span></div><Link className="btn btn-primary" href="/auth/join/client?next=%2Fworkspace%2Fclient%2Fjobs%2Fnew">Post your first job</Link></div><div className="card product-path-card product-path-card-secondary"><div className="product-path-icon"><ShieldCheck size={20}/></div><h3>For VAs: know exactly what to finish</h3><p>Your overview includes an onboarding checklist and profile-strength meter. The profile editor updates strength live while you add experience, skills, tools, availability, rate, and proof.</p><div className="mini-strength"><div className="row-between"><strong>Profile strength</strong><span>80%</span></div><div className="progress"><span style={{width:"80%"}}/></div><small>Public discovery also requires 2+ years of experience and final approval.</small></div><Link className="btn" href="/auth/join/va">Build a VA profile</Link></div></div></div></section>
