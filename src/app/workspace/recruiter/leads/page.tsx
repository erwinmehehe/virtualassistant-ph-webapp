              ...
              <section className="crm-client-context">
                ...
                {lead.discovery_scheduled_at ? <div className="crm-discovery-summary">
                  ...
                  <div className="row wrap">
                    ...
                    {!lead.discovery_meeting_url && discoveryScheduled ? <form action={createDiscoveryZoomLinkAction}><input type="hidden" name="lead_id" value={lead.id}/><input type="hidden" name="return_to" value={returnTo}/><button className="btn btn-sm btn-primary" type="submit">Create Google Meet</button></form> : null}
