...
test("blog content no longer depends on a runtime $5 pricing sanitizer", () => {
  ...
  assert.match(blog, /export const BLOG_POSTS: BlogPost\[\] = \[\.\.\.RAW_BLOG_POSTS, \.\.\.EDITORIAL_SEO_POSTS, \.\.\.BLOG_OPPORTUNITY_POSTS, \.\.\.BLOG_HIRING_GUIDES, \.\.\.BLOG_DEMAND_GUIDES, \.\.\.BLOG_KEYWORD_SUPPORT_GUIDES\];/);
