...
const stages = [["new","Applied"],["reviewing","Reviewing"],["shortlisted","Shortlisted"],["interview","Interview"],["rejected","Rejected"]] as const;
const stageFilters = [["","All"],["new","Applied"],["reviewing","Reviewing"],["shortlisted","Shortlisted"],["interview","Interview"],["hired","Hired"],["rejected","Rejected"]] as const;
...
export default async function ClientJobDetail({params,searchParams}:{params:Promise<{id:string}>;searchParams:Promise<Record<string,string|undefined>>}){
  ...
  const interviewCount=(applications||[]).filter((a:any)=>["interview","hired"].includes(a.status)).length;
