    ...
    <section className="section seo-content-section"><div className="container">
      <div className="seo-content-layout">
        <div className="seo-content-main">
          ...
          <p>General administrative, inbox and data work sits at roughly $5–8 an hour. Experienced specialists — executive assistants, customer support leads, ecommerce operations, bookkeepers — run about $8–12. Senior or heavily tool-specific roles go above that. Ongoing hourly roles cannot be posted below $5 an hour on this platform, and Virtual Assistant compensation is always shown separately from our service fee, so you can see exactly what reaches the person doing the work.</p>
