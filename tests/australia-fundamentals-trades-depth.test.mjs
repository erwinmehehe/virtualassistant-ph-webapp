...
const artifactPath =
  "supabase/migrations/20260924134000_finish_australia_fundamentals_trades_artifacts.sql";
const assessmentPath =
  "supabase/migrations/20260924134500_connect_australia_fundamentals_trades_assessments.sql";
...
test("worked examples cover high-judgment Australian VA and trades tasks", async () => {
  ...
  for (const phrase of [
    "not a usable scheduling rule",
    "does not make every field necessary",
    "recognising GST language is not the same as deciding GST treatment",
    "handoff priority follows the Australian workday",
    "record symptoms, not the customer",
    "an emergency script is a routing control",
