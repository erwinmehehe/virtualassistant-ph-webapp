...
export const SERVICE_PAGES: ServiceSeoPage[] = [
  ...
  },
  {
    ...
    "intro": "Hire a Graphic Design Virtual Assistant in the Philippines to handle social graphics, presentation design, and ad creative resizing. Give the Virtual Assistant a usable brief, source material, file standards, and one clear approval path before production starts.",
  ...
  },
  {
    ...
    "intro": "Hire a Video Editing Virtual Assistant in the Philippines to handle short-form editing, long-form rough cuts, and captioning. Give the Virtual Assistant a usable brief, source material, file standards, and one clear approval path before production starts.",
  ...
  },
  {
    ...
    "metaTitle": "Property Management Maintenance Virtual Assistant",
