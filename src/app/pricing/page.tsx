...
export default async function PricingPage(){
  ...
  return <><SiteHeader/><main id="main-content" className="pricing-page">
    ...
    <section className="section section-white"><div className="container"><div className="section-head"><h2>Current pricing structure</h2><p>Choose the service model that fits how much support you want after placement.</p></div><div className="grid-2">
    ...
    <section className="section"><div className="container"><div className="section-head"><h2>No mystery fee after you start interviewing.</h2><p>Your hiring request stays private during review. The applicable service terms are confirmed before you make a hiring commitment.</p></div><div className="process-grid"><div className="process-step"><div className="process-number">01</div><h3>Tell us the role</h3><p className="muted">Share the work, hours, schedule, and budget.</p></div><div className="process-step"><div className="process-number">02</div><h3>Review the terms</h3><p className="muted">Review VA compensation, the service model, and the client terms before proceeding.</p></div><div className="process-step"><div className="process-number">03</div><h3>Choose whether to proceed</h3><p className="muted">Move forward only when the role, shortlist process, and service model fit.</p></div></div></div></section>
  </main><SiteFooter/></>;
}
