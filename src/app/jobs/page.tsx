...
export const metadata: Metadata = {
  ...
  keywords: ["virtual assistant jobs philippines", "remote virtual assistant jobs", "work from home virtual assistant jobs", "filipino virtual assistant jobs"],
