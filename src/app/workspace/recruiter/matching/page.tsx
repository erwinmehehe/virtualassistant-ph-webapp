...
export default async function RecruiterMatchingPage({searchParams}:{searchParams:Promise<Record<string,string|undefined>>}){
  ...
  return <><div className="page-head"><div><div className="kicker">Recruiter role board</div><h1>Role matching</h1><p>Closed, stale, filled, and duplicate roles are out of the way by default. Work only the roles that need a decision.</p></div></div>
