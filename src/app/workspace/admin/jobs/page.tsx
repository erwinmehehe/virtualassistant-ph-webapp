...
export default async function AdminJobsPage({searchParams}:{searchParams:Promise<Record<string,string|undefined>>}){
  ...
  return <>
    ...
    {!showAll?<div className="info-banner" style={{marginBottom:18}}><strong>Complete standard curated roles stay recruiter-owned.</strong><p style={{margin:"6px 0 0"}}>Admin only sees curated roles here when the brief is incomplete. Otherwise the assigned recruiter owns qualification, standard terms, and client follow-up.</p></div>:null}
