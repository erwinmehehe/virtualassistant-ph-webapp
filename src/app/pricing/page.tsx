...
export const metadata: Metadata = { title: "How Virtual Assistant Pricing Works", description: "Estimate Virtual Assistant compensation and understand curated placement and managed service pricing before you publish a role.", keywords: ["virtual assistant pricing philippines", "how much does a virtual assistant cost", "virtual assistant rates"] , alternates: { canonical: canonicalPath("/pricing") }};
...
export default async function PricingPage(){
  ...
  return <><SiteHeader/><main id="main-content">
    ...
    <section className="section section-white"><div className="container"><div className="section-head"><h2>Current pricing structure</h2><p>Choose the service model that fits how much recruiting and post-hire support you want. Virtual Assistant compensation is agreed separately, based on experience and specialization.</p></div><div className="grid-2">
      <article className="card pricing-card"><span className="pricing-label">Managed Virtual Assistant service <span className="badge badge-success">Recommended</span></span><h3>Ongoing service margin</h3><div className="pricing-value">{managedMarkup > 0 ? `${managedMarkup}%` : "Custom quote"}</div><p className="muted">Added on top of Virtual Assistant compensation, for as long as you work together. {managedMarkup > 0 ? "This is the current standard managed-service margin; your role terms are confirmed before publishing." : "The managed-service margin is quoted against the actual role before you accept the engagement."}</p><ul className="check-list"><li>Recruiting, screening, and matching</li><li>Structured onboarding workroom</li><li>Ongoing placement support</li><li>30-day replacement support at no extra placement fee</li></ul><Link className="btn btn-primary" href="/hire">Hire a Virtual Assistant <ArrowRight size={16}/></Link></article>
    ...
    <p className="pricing-note" style={{ marginTop: 20 }}>Virtual Assistant compensation starts at USD {MIN_HOURLY_RATE}/hour for straightforward, entry-level work -- an experienced specialist (bookkeeper, estimator, mortgage processor) should cost more, and the exact budget is set with you before a role is published. <Link href="/managed-vs-direct-hire">See a side-by-side comparison of Managed Virtual Assistant vs. Direct Hire →</Link></p>
    </div></section>
    ...
    <section className="section"><div className="container"><div className="section-head"><h2>No surprise fee after you start interviewing.</h2><p>Your role stays private during review. The applicable service fee is shown before publishing, and you choose whether to continue.</p></div><div className="process-grid"><div className="process-step"><div className="process-number">01</div><h3>Send the workload</h3><p className="muted">Share the role, hours, schedule, and Virtual Assistant budget.</p></div><div className="process-step"><div className="process-number">02</div><h3>Review the terms</h3><p className="muted">See the service model and fee separately from Virtual Assistant compensation.</p></div><div className="process-step"><div className="process-number">03</div><h3>Publish only if it fits</h3><p className="muted">Accept the terms before the job goes live and candidates enter the hiring workflow.</p></div></div></div></section>
  </main><SiteFooter/></>;
}
