...
export const metadata:Metadata={title:"Virtual Assistant Job Description Generator",description:"Create a practical VA job description with responsibilities, tools, hours, success measures, and a fair minimum hourly budget.",alternates:{canonical:canonicalPath("/tools/virtual-assistant-job-description-generator")}};
