...
export default async function VaProfilePage({searchParams}:{searchParams:Promise<Record<string,string|undefined>>}) {
  ...
  return <>
    ...
    <div className="page-head"><div><div className="kicker">Profile & readiness</div><h1>Get ready for client matching</h1><p>Keep your professional profile, availability, work setup, and vetting progress in one place.</p></div><Link className="btn" href="/workspace/va/profile/preview" target="_blank"><Eye size={16}/> Preview profile</Link></div>
    ...
    <div className="profile-editor-layout">
      <div className="stack">
        <form id="va-profile-form" action={updateVaProfileAction} className="stack profile-editor-form" encType="multipart/form-data">
          ...
          <div className="profile-savebar"><span className="small muted">Save whenever you make meaningful changes. Some vetted evidence may require re-approval.</span><button className="btn btn-primary" type="submit">Save profile</button></div>
        </form>
