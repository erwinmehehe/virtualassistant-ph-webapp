...
import { PlayCircle, CheckCircle2, LockKeyhole, Mail, MessageSquare, ShieldCheck } from "lucide-react";
...
export default async function CandidateReviewPage({params,searchParams}:{params:Promise<{id:string}>;searchParams:Promise<Record<string,string|undefined>>}){
  ...
  const [{data:a},{data:conversation},{data:history},{data:vetting}]=await Promise.all([
