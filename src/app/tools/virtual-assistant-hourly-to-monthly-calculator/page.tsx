...
export const metadata:Metadata={title:"VA Hourly to Monthly Cost Calculator",description:"Convert a virtual assistant hourly rate and weekly hours into weekly, monthly, and annual budget estimates.",alternates:{canonical:"/tools/virtual-assistant-hourly-to-monthly-calculator/"}};
