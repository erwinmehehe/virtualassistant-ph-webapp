-- Release the reviewed SEO Virtual Assistant course.
-- Editorial review complete. This course teaches operational SEO support, not guaranteed rankings.
...
set
  ...
  content_version = greatest(content_version, 2),
  updated_at = now()
where slug = 'seo-virtual-assistant';
