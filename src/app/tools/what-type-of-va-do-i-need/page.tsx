...
export const metadata:Metadata={title:"What Type of Virtual Assistant Do I Need?",description:"Choose the workload that is falling behind and get pointed to the closest VA service, role guide, and hiring path.",alternates:{canonical:canonicalPath("/tools/what-type-of-va-do-i-need")}};
